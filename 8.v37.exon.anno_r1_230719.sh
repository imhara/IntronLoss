...
#2024.01.22 updated sample names re-setting
...
then
    continue
        ...
        echo -e "$sample\t$read\t$flag\t$chr\t$pos\t$maoq\t$cigar\t$rnext\t$pnext\t$tlen\t$seq\t$bed_info\tr1" | tr -d '\r' >> ${output_dir}/${sample}.b37.R3.r1.out.txt
